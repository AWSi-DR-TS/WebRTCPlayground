...
namespace Microsoft.MixedReality.WebRTC.Unity
{
    ...
    public class OpenViduSignaler : Signaler, IDataReceiver
    {
        ...
        private void Start()
        {
            ...
            Debug.Log("testeeasdasdasdasdasdasd");
            RetrofitAdapter adapter = new RetrofitAdapter.Builder()
         .SetEndpoint("https://zweitblick.awsi.cloud/")
         .Build();
            httpService = adapter.Create<IHttpBinInterface>();

            var ob = httpService.Post("maris_client_glass", "password", "openid", "glass_user", "4MHIyOZq$NU=TchA<PGZ");
